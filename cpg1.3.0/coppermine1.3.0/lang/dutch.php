...
// ------------------------------------------------------------------------- //
// $Id: dutch.php,v 1.11 2004/05/02 21:18:10 gaugau Exp $
// ------------------------------------------------------------------------- //
...
if (defined('CONFIG_PHP')) $lang_config_data = array(
        ...
        array('Gebruikers kunnen privé albums hebben, (Notitie: Indien je veranderd van \'Ja\' naar \'Nee\' wordt ieder privé album publiek)', 'allow_private_albums', 1),
...
$lang_picinfo = array(
        ...
        'iptcSubCategories'=>'IPTC Sub Categorieën',
);
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array(
	  ...
	  'dir_cant_read' => 'Niet leesbaar. ',
        ...
        'notes' =>  '<ul>'.
                                ...
                                '<li><b>NA</b> : betekent dat je geen album geselecteerd hebt waar de bestanden in moeten, klik \'<a href="javascript:history.back(1)">Terug</a>\' en selecteer een album. Als je geen album hebt <a href="albmgr.php">creëer er eerst één</a></li>'.
...
if (defined('UPLOAD_PHP')) $lang_upload_php = array(
	  ...
	  'cant_create_write' => 'Kan schrijf bestand niet creëeren.', //cpg1.3.0
