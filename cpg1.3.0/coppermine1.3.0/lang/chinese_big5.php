...
// ------------------------------------------------------------------------- //
// $Id: chinese_big5.php,v 1.5 2004/04/09 08:18:41 gaugau Exp $
// ------------------------------------------------------------------------- //

// info about translators and translated language
$lang_translation_info = array(
  'lang_name_english' => 'Chinese Tranditional BIG5',
  'lang_name_native' => '繁體中文BIG5',
...
$lang_meta_album_names = array(
  ...
  'lasthits' => '最近顯示',
  'search' => '搜尋結果',
  'favpics'=> '我的最愛', //cpg1.3.0
);

$lang_errors = array(
  'access_denied' => '你沒有使用本頁的權限!.',
  'perm_denied' => '你沒有權限執行此動作!.',
  'param_missing' => '程式被呼叫而 沒有需要的參數!.',
  'non_exist_ap' => '所選擇的 相簿/影像 不存在 !', //cpg1.3.0
  'quota_exceeded' => '超過磁碟配額<br /><br />你的配額有 [quota]K, 已使用的有 [space]K, 加入此影像會超過配額.', //cpg1.3.0
  'gd_file_type_err' => '當使用 GD 圖像程式庫只容許 JPEG / PNG 圖檔.',
  'invalid_image' => '你上傳的檔案己經損壞, 或是 GD 圖像程式庫不能處理',
  'resize_failed' => '無法建立縮圖或變更圖檔尺寸.',
  'no_img_to_display' => '還沒有影像可以顯示.',
  'non_exist_cat' => '所選擇的類別並不存在.',
  'orphan_cat' => '這個子類別存於一個不存在的父類別, 請先至類別管理修正這個問題.', //cpg1.3.0
  'directory_ro' => '目錄 \'%s\' 無法寫入, 導致影像無法刪除', //cpg1.3.0
  'non_exist_comment' => '所選擇的留言並不存在.',
  'pic_in_invalid_album' => '此影像存於 不存在的相簿 (%s)!?', //cpg1.3.0
  'banned' => '你目前被禁止使用本網站.',
  'not_with_udb' => '由於本相簿已和論壇程式整合, 此功能停止使用. 可能是目前設定不支援, 或已由論壇處理.', 
  'offline_title' => '離線', //cpg1.3.0
  'offline_text' => '相簿目前離線- 請稍後再試', //cpg1.3.0
  'ecards_empty' => '目前沒有電子卡片的紀錄可顯示. 請檢查相簿設定中是否啟用電子卡片日誌!', //cpg1.3.0
  'action_failed' => '動作失敗.  Coppermine 無法執行你的要求.', //cpg1.3.0
  'no_zip' => '無法執行ZIP壓縮檔.  請聯絡你的相簿管理員.', //cpg1.3.0
  'zip_type' => '你沒有權限上傳ZIP壓縮檔.', //cpg1.3.0
);

$lang_bbcode_help = '可以參考的編碼: <li>[b]<b>Bold</b>[/b]</li> <li>[i]<i>Italic</i>[/i]</li> <li>[url=http://yoursite.com/]Url Text[/url]</li> <li>[email]user@domain.com[/email]</li>'; //cpg1.3.0
...
$lang_main_menu = array(
  ...
  'usr_mode_lnk' => '會員模式',
  'upload_pic_title' => '上傳影像至相簿', //cpg1.3.0
  'upload_pic_lnk' => '上傳影像', //cpg1.3.0
  ...
  'search_lnk' => '搜尋',
  'fav_lnk' => '我的最愛',
  'memberlist_title' => '顯示會員列表', //cpg1.3.0
  'memberlist_lnk' => '會員列表', //cpg1.3.0
  'faq_title' => '相簿的常見問題解答 &quot;Coppermine&quot;', //cpg1.3.0
  'faq_lnk' => '常見問題', //cpg1.3.0
);
...
$lang_thumb_view = array(
  ...
  'pic_on_page' => '%d 影像在 %d 頁',
  'user_on_page' => '%d 會員在 %d 頁', //cpg1.3.0
);

$lang_img_nav_bar = array(
  'thumb_title' => '返回縮圖頁',
  'pic_info_title' => '顯示/隱藏 影像資訊', //cpg1.3.0
  'slideshow_title' => '連續播放',
  'ecard_title' => '把圖片以電子卡片寄出', //cpg1.3.0
  'ecard_disabled' => '電子卡片功能目前停用',
  'ecard_disabled_msg' => '你沒有權限寄電子卡片', //js-alert //cpg1.3.0
  'prev_title' => '觀看前一張影像', //cpg1.3.0
  'next_title' => '觀看下一張影像', //cpg1.3.0
  'pic_pos' => '影像 %s/%s', //cpg1.3.0
);

$lang_rate_pic = array(
  'rate_this_pic' => '對影像評分', //cpg1.3.0
  'no_votes' => '(還沒有人評分)',
...
$lang_cpg_debug_output = array(
  ...
  'copy_and_paste_instructions' => '如果你要在Coppermine支援論壇上要求協助, 複製並貼上 這個除錯訊息到你的發表文章內. 發表文章前請確定用***取代你的密碼.', //cpg1.3.0
  'phpinfo' => '顯示php訊息', //cpg1.3.0
);

$lang_language_selection = array(
  'reset_language' => '預設語言', //cpg1.3.0
  'choose_language' => '選擇你的語言', //cpg1.3.0
);

$lang_theme_selection = array(
  'reset_theme' => '預設佈景主題', //cpg1.3.0
  'choose_theme' => '選擇佈景主題', //cpg1.3.0
);
...
if (defined('CONFIG_PHP')) $lang_config_data = array(
  ...
  array('相簿管理員電子郵件', 'gallery_admin_email', 0),
  array('在電子卡片內顯示\'觀看更多影像\'的網址', 'ecards_more_pic_target', 0),
  array('相簿目前離線中', 'offline', 1), //cpg1.3.0
  array('電子卡片日誌', 'log_ecards', 1), //cpg1.3.0
  array('允許將最愛的影像下載成ZIP檔', 'enable_zipdownload', 1), //cpg1.3.0

  '語系, 佈景 &amp; 文字編碼設定',
  array('語言', 'lang', 5),
  array('佈景', 'theme', 6),
  array('顯示語言列表', 'language_list', 8), //cpg1.3.0
  array('顯示語言國旗', 'language_flags', 8), //cpg1.3.0
  array('顯示 &quot;重設&quot; 在語言選擇', 'language_reset', 1), //cpg1.3.0
  array('顯示佈景列表', 'theme_list', 8), //cpg1.3.0
  array('顯示 &quot;重設&quot; 在佈景選擇', 'theme_reset', 1), //cpg1.3.0
  array('顯示 FAQ', 'display_faq', 1), //cpg1.3.0
  array('顯示 bbcode help', 'show_bbcode_help', 1), //cpg1.3.0
...
array('相簿目錄頁相簿欄數', 'album_list_cols', 0),
  ...
  array('顯示影像說明於縮圖下方 (附加的標題)', 'caption_in_thumbview', 1), //cpg1.3.0
  ...
  array('影像的原始排序次序', 'default_sort_order', 3), //cpg1.3.0
  array('\'熱門評分\'需要最少評分數', 'min_votes_for_rating', 0), //cpg1.3.0

  '影像顯示 &amp; 留言設定',
  array('影像顯示的表格寬度 (像素或 %)', 'picture_table_width', 0), //cpg1.3.0
  array('影像資訊預設顯示', 'display_pic_info', 1), //cpg1.3.0
  array('留言內過濾不良詞彙', 'filter_bad_words', 1),
  array('留言可以使用笑臉圖示', 'enable_smilies', 1),
  array('允許會員在同一張影像 連續發表留言(關閉灌水保護)', 'disable_comment_flood_protect', 1), //cpg1.3.0
  array('影像描述內容的最大長度', 'max_img_desc_length', 0),
  array('描述內容的最大字數', 'max_com_wlength', 0),
  array('留言的最大行數', 'max_com_lines', 0),
  array('留言的最大長度', 'max_com_size', 0),
  array('顯示影像預覽列', 'display_film_strip', 1),
  array('影像預覽列 的影像數', 'max_film_strip_items', 0),
  array('有留言時 用電子郵件通知管理員', 'email_comment_notification', 1), //cpg1.3.0
  array('連續撥放間隔幾 毫秒(1 秒 = 1000 毫秒)', 'slideshow_interval', 0), //cpg1.3.0
  ...
  array('建立中級影像','make_intermediate',1),
  array('中級影像/影片最大尺寸 <a href="#notice2" class="clickable_option">**</a>', 'picture_width', 0), //cpg1.3.0
  array('上傳影像的最大限制 (KB)', 'max_upl_size', 0), //cpg1.3.0
  array('上傳圖片/影片最大寬或高尺寸 (像素)', 'max_upl_width_height', 0), //cpg1.3.0

  '影像和縮圖的進階設定', //cpg1.3.0
  array('顯示私人相簿影像給未登入會員','show_private',1), //cpg1.3.0
  array('檔案名稱不接受的字符', 'forbiden_fname_char',0), //cpg1.3.0
  //array('上傳圖檔可接受的副檔名', 'allowed_file_extensions',0), //cpg1.3.0
  array('可接受的圖片檔類型', 'allowed_img_types',0), //cpg1.3.0
  array('可接受的影片檔類型', 'allowed_mov_types',0), //cpg1.3.0
  array('可接受的聲音檔類型', 'allowed_snd_types',0), //cpg1.3.0
  array('可接受的文件檔類型', 'allowed_doc_types',0), //cpg1.3.0
  ...
  array('上傳影像的預設權限', 'default_file_mode', 0), //cpg1.3.0

  '會員設定',
  array('允許新會員註冊', 'allow_user_registration', 1),
  array('註冊需要電子郵件驗證', 'reg_requires_valid_email', 1),
  array('有使用者註冊時 用電子郵件通知管理員', 'reg_notify_admin_email', 1), //cpg1.3.0
  ...
  array('有會員上傳檔案等待核准時 通知管理員', 'upl_notify_admin_email', 1), //cpg1.3.0
  array('允許登入的會員查看會員列表', 'allow_memberlist', 1), //cpg1.3.0
  ...
  '<br /><div align="left"><a name="notice1"></a>(*) 若相簿內有影像, 標示有 * 的欄位表示不可更改.<br />
  <a name="notice2"></a>(**) 改變這個設定只影響已經加入的檔案, 如果那些檔案已經在相簿內了,這個設定不必改變. 無論如何,你可以從 管理員功能選單裡 調整既有的檔案,從 &quot;<a href="util.php">管理工具</a> (調整影像尺寸)&quot; </div><br />', //cpg1.3.0
);
...
if (defined('DB_ECARD_PHP')) $lang_db_ecard_php = array(
  ...
  'ecards_delete_selected' => '刪除已經選擇的卡片', //cpg1.3.0
...
if (defined('DB_INPUT_PHP')) $lang_db_input_php = array(
  ...
  'err_move' => '無法搬移 %s 到 %s !',
  'err_fsize_too_large' => '您上傳的影像太大 (不能超過 %s x %s) !', //cpg1.3.0
  'err_imgsize_too_large' => '您上傳的圖檔太大 (不能超過 %s KB) !',
  'err_invalid_img' => '上傳的檔案並不是容許的影像格式 !',
  'allowed_img_types' => '您只可以上傳 %s 張影像.',
  ...
  'no_flood' => '抱歉, 此影像最後一個留言是您提供<br /><br />您可以修改您的留言', //cpg1.3.0
  'redirect_msg' => '頁面轉移中.<br /><br /><br />按 \'繼續\' 如果頁面沒有自動更新',
  'upl_success' => '已經加入您的檔案', //cpg1.3.0
  'email_comment_subject' => '已經有留言發表在網路相簿', //cpg1.3.0
  'email_comment_body' => ' 您的網路相簿上有新的留言. 請查閱! ', //cpg1.3.0
);
...
$lang_display_image_php = array(
  'confirm_del' => '確定要刪除此影像嗎 ? \\n留言也會被刪除.', //js-alert //cpg1.3.0
  'del_pic' => '刪除此影像', //cpg1.3.0
  'size' => '%s x %s 像素',
  'views' => '%s 次',
  'slideshow' => '連續播放',
  'stop_slideshow' => '停止播放',
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php =array(
  ...
  'ecard_title' => '%s 寄來給你的 電子卡片',
  'error_not_image' => '電子卡片只能寄出 圖片.', //cpg1.3.0
  'view_ecard' => '如果 電子卡片 無法正確顯示, 請按此連結',
  'view_more_pics' => '按此連結看更多影像 !',
  'send_success' => '你的 電子卡片 寄出',
...
if (defined('EDITPICS_PHP')) $lang_editpics_php = array(
  ...
  'del_comm' => '刪除留言',
  'upl_approval' => '核准上傳',
  'edit_pics' => '編輯影像', //cpg1.3.0
  'see_next' => '觀看下一張影像', //cpg1.3.0
  'see_prev' => '觀看前一張影像', //cpg1.3.0
  'n_pic' => '%s 張影像', //cpg1.3.0
  'n_of_pic_to_disp' => '影像顯示數量', //cpg1.3.0
  'apply' => '確認修改', //cpg1.3.0
  'crop_title' => 'Coppermine 影像編輯器', //cpg1.3.0
  'preview' => '預覽', //cpg1.3.0
  'save' => '存檔', //cpg1.3.0
...
if (defined('FAQ_PHP')) $lang_faq_data = array(
  ...
  array('如何登入?', '到 &quot;登入&quot;, 填入你的會員名稱及密碼 且勾選 &quot;記住我&quot; 下次你再來的時候就會自動登入了.<br /><b>注意:如果你點選 &quot;記住我 &quot; ,Cookies 功能必須開啟,讓cookie存在你的電腦中..</b>', 'offline', 0), //cpg1.3.0
  array('為何無法登入?', '你已經註冊並 啟用帳號了嗎(回覆認證郵件的連結)?. 那個連結將會啟用你的帳號. 其他登入問題 請聯絡網站管理員.', 'offline', 0), //cpg1.3.0
  ...
  array('如何把影像存到  &quot;我的最愛 &quot;?', '點選影像並且點按 &quot;影像資訊&quot; 連結 (<img src="images/info.gif" width="16" height="16" border="0" alt="Picture information" />); 在影像資訊設定裡面按 &quot;加入我的最愛&quot;.<br />管理員可能有預設的&quot;影像資訊&quot; .<br />注意:Cookies 功能必須開啟,讓cookie存在你的電腦中.', 'offline', 0), //cpg1.3.0
  array('如何對影像評分 ?', '點按該影像縮圖,在影像底下可以點選你的評分.', 'offline', 0), //cpg1.3.0
  array('如何發表留言 ?', '點按該影像縮圖,在影像底下可以發表留言.', 'offline', 0), //cpg1.3.0
  array('如何上傳影像 ?', '到 &quot;上傳影像&quot;並選擇你要上傳到哪一個相簿,按 &quot;瀏覽&quot; 且點選要上傳的影像 按 &quot;開啟&quot; (你可以加入影像標題及描述) 然後按 &quot;確認&quot;', 'allow_private_albums', 0), //cpg1.3.0
  array('上傳影像到哪裡 ?', '你可以上傳影像到 &quot;我的相簿&quot;. 管理員也可能允許你上傳影像到主相簿內.', 'allow_private_albums', 0), //cpg1.3.0
  ...
  array('如何新增,修改 或刪除相簿 從 &quot;我的相簿&quot;?', '你必須在 &quot;管理模式&quot;<br />到 &quot;新增/排序 我的相簿&quot;按 &quot;新增&quot;.  修改 &quot;新相簿&quot; 到你想要的名稱.<br />你可以對你的每一個相簿重新命名.<br />按 &quot;確認修改&quot;.', 'allow_private_albums', 0), //cpg1.3.0
  array('我要如何禁止其他會員看我的相簿?', '你必須在 &quot;管理模式&quot;<br />到 &quot;編輯我的相簿&quot;. 在 &quot;更新相簿&quot; 欄位, 選擇你要變更的相簿.<br />在這裡, 你可以變更相簿名稱 描述 縮圖 ,及限制觀看 留言 評分 的權限.<br />然後按 &quot;更新相簿&quot;.', 'allow_private_albums', 0), //cpg1.3.0
  ...
  array('在哪裡可以取得這個相簿程式?', 'Coppermine 是基於GNU GPL的免費多媒體相簿. 它是全功能的 且支援不同的平台. 請到<a href="http://coppermine.sf.net/">Coppermine 的網站</a> 取得更多的資訊 或是下載它.<br />繁體中文版問題請到<a href="http://cpg.38.com/">這裡</a> 取得更多的資訊', 'offline', 0), //cpg1.3.0

  '網站導引', //cpg1.3.0
  array('什麼是 &quot;相簿目錄 &quot;?', '這將顯示整個相簿 包含每一個分類. 點選縮圖可以連結到類別中.', 'offline', 0), //cpg1.3.0
  ...
  array('什麼是 &quot;上傳影像 &quot;?', '這項功能允許會員上傳影像(檔案大小及格式依管理員設定) 到指定的相簿.', 'allow_private_albums', 0), //cpg1.3.0
  array('什麼是 &quot;最新上傳 &quot;?', '這項功能顯示最新上傳到相簿的檔案.', 'offline', 0), //cpg1.3.0
  array('什麼是 &quot;最新留言 &quot;?', '這項功能是會員或訪客對影像發表的最新留言.', 'offline', 0), //cpg1.3.0
  array('什麼是 &quot;熱門影像 &quot;?', '這項功能顯示被觀看最多次的影像,不論是會員或訪客.', 'offline', 0), //cpg1.3.0
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array(
  ...
  'title' => '管理群組',
  'approval_1' => '容許上傳到公開相簿 (1)',
  'approval_2' => '容許上傳到私人相簿 (2)',
  ...
  'note1' => '<b>(1)</b> 上傳影像至公開相簿需管理員核准',
  'note2' => '<b>(2)</b> 上傳影像至私人相簿需管理員核准',
  'notes' => '注意',
);
...
if (defined('PHPINFO_PHP')) $lang_phpinfo_php = array(
  'php_info' => 'PHP 資訊', //cpg1.3.0
  'explanation' => '這是由PHP-function 產生 <a href="http://www.php.net/phpinfo">phpinfo()</a>, Copermine 截取部分內容顯示.', //cpg1.3.0
  'no_link' => '其他人看到你的 phpinfo 會有安全上的風險, 這就是為何 當你以管理員身分登入時才會看到此頁的原因. 你不能將本頁的連結給其他人, 因為它們將會遇到存取錯誤.', //cpg1.3.0
);
...
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array(
  'already_rated' => '抱歉, 您已經為此影像評分', //cpg1.3.0
  'rate_ok' => '您的評分已經被接受',
  'forbidden' => '你不能對你自己的影像評分.', //cpg1.3.0
);
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array(
  'page_title' => '搜尋新影像', //cpg1.3.0
  'select_dir' => '選擇目錄',
  'select_dir_msg' => '本功能可以讓你用 FTP 上傳整批影像.<br /><br />請選擇你已上傳影像的目錄', //cpg1.3.0
  'no_pic_to_add' => '沒有影像可以加入', //cpg1.3.0
  'need_one_album' => '使用此功能必需少要有一個相簿',
  'warning' => '警告',
  'change_perm' => '程式無法寫入這個目錄, 請修改權限至 755 或r 777 後再試一次 !', //cpg1.3.0
  'target_album' => '<b>把影像由 &quot;</b>%s<b>&quot; 到 </b>%s', //cpg1.3.0
  'folder' => '資料夾',
  'image' => '影像',
  'album' => '相簿',
  'result' => '結果',
  'dir_ro' => '無法寫入. ',
  'dir_cant_read' => '無法讀取. ',
  'insert' => '新增影像至相簿', //cpg1.3.0
  'list_new_pic' => '列出新影像', //cpg1.3.0
  'insert_selected' => '加入所選擇的影像', //cpg1.3.0
  'no_pic_found' => '沒有找到新影像', //cpg1.3.0
  'be_patient' => '請耐心等候, 程式需要一點時間來加入所選影像', //cpg1.3.0
  'no_album' => '沒有相簿被選擇',  //cpg1.3.0
  'notes' =>  '<ul>'.
                          '<li><b>OK</b> : 表示影像已成功被加入'.
                          '<li><b>DP</b> : 表示影像重覆或已存在資料庫'.
                          '<li><b>PB</b> : 表示影像無法加入, 請檢查設定或影像存放目錄的權限'.
                          '<li><b>NA</b> : 表示你還沒有選擇影像的相簿, 按 \'<a href="javascript:history.back(1)">返回</a>\' 並選擇相簿. 如果你沒有相簿 <a href="albmgr.php">請先建立一個</a></li>'.
                          '<li>如果 OK, DP, PB \'符號\' 沒有顯示請按壞掉的影像查看 PHP 顯示的錯誤訊息'.
                          '<li>如果瀏覽器逾時, 請按重新整理'.
                          '</ul>', //cpg1.3.0
...
if (defined('BANNING_PHP')) $lang_banning_php = array(
  ...
  'user_name' => '會員名稱',
  'ip_address' => 'IP位址',
  'expiry' => '停權期限（空白代表永久停權）',
  'edit_ban' => '儲存修改',
  'delete_ban' => '刪除',
  'add_new' => '新增停權會員',
  'add_ban' => '新增',
  'error_user' => '找不到該使用者名稱!你沒打錯吧.. ', //cpg1.3.0
  'error_specify' => '你需要具體指明使用者名稱或IP位址', //cpg1.3.0
...
if (defined('UPLOAD_PHP')) $lang_upload_php = array(
  ...
  'reg_instr_2' => '現在 你可以用以下的上傳框 上傳你的檔案. 每一個上傳檔案的大小不可以超過 %s KB . ZIP 檔案上傳在 \'檔案上傳\' 及 \'URI/URL 上傳\' 區 .', //cpg1.3.0
  ...
  'MIME_extraction_failure' => 'MIME 無法被測定.', //cpg1.3.0
  ...
  'cant_unzip' => '無法 unzip.', //cpg1.3.0
  'unknown' => '未知的錯誤', //cpg1.3.0
  'succ' => '成功上傳', //cpg1.3.0
  'success' => '%s 上傳已經成功.', //cpg1.3.0
  'add' => '請按 \'繼續\' 增加檔案到相簿.', //cpg1.3.0
  'failure' => '上傳失敗', //cpg1.3.0
  'f_info' => '檔案資訊', //cpg1.3.0
  'no_place' => '先前的檔案無法被配置.', //cpg1.3.0
  'yes_place' => '先前的檔案已經配置成功.', //cpg1.3.0
  'max_fsize' => '最大允許檔案大小是 %s KB',
  'album' => '相簿',
  'picture' => '影像', //cpg1.3.0
  'pic_title' => '影像標題', //cpg1.3.0
  'description' => '影像描述', //cpg1.3.0
  'keywords' => '關鍵字 (以空格區隔)',
  'err_no_alb_uploadables' => '目前尚未有相簿可以上傳影像', //cpg1.3.0
  'place_instr_1' => '現在 請將影像放到相簿.  你現在可以輸入這個檔案的相關資訊.', //cpg1.3.0
  'place_instr_2' => '更多的影像需要配置. 請按 \'繼續\'.', //cpg1.3.0
  'process_complete' => '恭喜  你已經將全部的成功檔案上傳了.', //cpg1.3.0
);
...
if (defined('USERMGR_PHP')) $lang_usermgr_php = array(
  ...
  'confirm_del' => '確定要刪除這個會員嗎? \\n所有他的相簿及影像都會被刪除.', //js-alert //cpg1.3.0
  'mail' => '電子郵件',
...
if (defined('UTIL_PHP')) $lang_util_php = array(
  'title' => '管理工具 (調整影像大小)', //cpg1.3.0
  'what_it_does' => '功能',
  'what_update_titles' => '依據檔案名稱 更新影像標題',
  'what_delete_title' => '刪除影像標題',
  'what_rebuild' => '重建縮圖及調整影像大小',
  'what_delete_originals' => '重新調整後的影像 將取代原有的影像',
  'file' => ' 檔案 ',
  'title_set_to' => ' 標題變更為 ',
  'submit_form' => ' 確認 ',
  'updated_succesfully' => ' 更新 已經成功 ',
  'error_create' => ' 產生錯誤 ',
  'continue' => ' 繼續執行其他的影像 ',
  ...
  'replace_wait' => '重新調整後的影像將 取代原有的影像中, 請稍待... ',
  'instruction' => '簡易操作說明 ',
  'instruction_action' => '請選擇操作 ',
  'instruction_parameter' => '設定參數 ',
  'instruction_album' => '選擇相簿 ',
  'instruction_press' => '請按 %s ',
  'update' => '更新縮圖 且/或 調整影像大小 ',
  'update_what' => '要更新什麼 ',
  'update_thumb' => '只有縮圖',
  'update_pic' => '只調整影像大小',
  'update_both' => '更新縮圖且調整影像尺寸',
  'update_number' => '每點選一次要處理的影像數目',
  'update_option' => '(如果您遇到操作程序逾時的問題，請試著降低此設定)',
  'filename_title' => '檔案名稱 &rArr; 影像標題', //cpg1.3.0
  'filename_how' => '如何修改檔名', 
  ...
  'delete' => '刪除影像標題或原始尺寸的影像', //cpg1.3.0
  'delete_title' => '刪除影像標題', //cpg1.3.0
  'delete_original' => '刪除原始尺寸的影像',
  'delete_replace' => '刪除原始尺寸的影像並以調整尺寸的影像取代',
  'select_album' => '選擇相簿',
  ...
  'update_db_explanation' => '如果您有更新 coppermine 檔案, 加以修改或由以前的版本升級, 請務必執行一次資料庫更新. 這將會在資料庫新增必要的資料表 及/或 設定值.', //cpg1.3.0
);
