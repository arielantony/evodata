...
// ------------------------------------------------------------------------- //
// $Id: slovenian.php,v 1.10 2004/05/02 21:18:12 gaugau Exp $
// ------------------------------------------------------------------------- //
...
$lang_meta_album_names = array(
  'random' => 'Nakljuène datoteke', //cpg1.3.0
...
$lang_errors = array(
  ...
  'quota_exceeded' => 'Disk je poln<br /><br />Na razpolago imaš [quota]K, tvoje slike pa trenutno zasedajo [space]K, èe bi dodal pa še to sliko, bi prekoraèil prostor na disku.', //cpg1.3.0
  ...
  'orphan_cat' => 'Kategorija ima doloèeno neobstojeèo nadrejeno kategorijo. Popravi napako v nastavitvah.', //cpg1.3.0
  'directory_ro' => 'Direktorij \'%s\' ne dopušèa pisanja, slik ni možno pobrisati', //cpg1.3.0
  'non_exist_comment' => 'Izbrani komentar ne obstaja.',
  'pic_in_invalid_album' => 'Slika je v neobstojeèem albumu (%s)!?', //cpg1.3.0
  ...
  'ecards_empty' => 'Trenutno ni podatkov o poslanih e-razglednicah. Preveri, èe je v nastavitvah vklopljeno beleženje poslanih e-razglednic!', //cpg1.3.0
  'action_failed' => 'Ukaz je bil prekinjen. Tvojega zahtevka ni možno izvesti.', //cpg1.3.0
  'no_zip' => 'Potrebna knjižnica za izvedbo ZIP datoteke manjka. Sporoèi napako administratorju galerije.', //cpg1.3.0
  'zip_type' => 'Nimaš dovoljenja za nalaganje ZIP datotek.', //cpg1.3.0
);

$lang_bbcode_help = 'Naslednje kode so lahko v pomoè: <li>[b]<b>Povdarjeno</b>[/b]</li> <li>[i]<i>Poševno</i>[/i]</li> <li>[url=http://tvojastran.com/]Url besedilo[/url]</li> <li>[email]nekaj@domain.com[/email]</li>'; //cpg1.3.0
...
$lang_main_menu = array(
  ...
  'memberlist_title' => 'Pokaži seznam èlanov', //cpg1.3.0
  'memberlist_lnk' => 'Seznam èlanov', //cpg1.3.0
...
$lang_cpg_debug_output = array(
  ...
  'copy_and_paste_instructions' => 'Èe želiš pomoè s strani coppermine foruma, kopiraj in prilepi (copy-paste) izpis napake v svoje sporoèilo. Pred pošiljanjem preveri in zamenjaj (èe obstaja v izpisu) geslo z ***.', //cpg1.3.0
...
if (defined('CONFIG_PHP')) $lang_config_data = array(
  ...
  array('Dovoli veè komentarjev od enega uporabnika (iklopi kontrolo smeti...)', 'disable_comment_flood_protect', 1), //cpg1.3.0
  ...
  array('Naèin kreiranja ikon','thumb_method',2), //cpg1.3.0
  ...
  array('Uporabniki imajo lahko privatne albume (Opomba: èe preklopiš iz DA na NE bodo trenutni privatni albumi postali javni)', 'allow_private_albums', 1), //cpg1.3.0
  array('Obvesti admina o èakajoèih slikah za odobritev', 'upl_notify_admin_email', 1), //cpg1.3.0
  array('Dovoli prijavljenim uporabnikom ogled seznama èlanov', 'allow_memberlist', 1), //cpg1.3.0
  ...
  'Piškotki',
  array('Ime za piškotke, ki jih uporablja galerija (èe uporabljaš še bbs, poskrbi za razlièno ime od piškotkov bbs-ja)', 'cookie_name', 0),
  array('Pot do piškotkov', 'cookie_path', 0),

  'Ostale nastavitve',
  array('Vkljuèi naèin za odkrivanje napak', 'debug_mode', 9), //cpg1.3.0
  array('Prikaži opombe v naèinu za odkrivanje napak', 'debug_notice', 1), //cpg1.3.0

  '<br /><div align="left"><a name="notice1"></a>(*) Teh nastavitev ni dovoljeno spreminjati, ko so v galeriji že slike.<br />
  <a name="notice2"></a>(**) Èe spremeniš te nastavitve, bodo vplivale samo na slike dodane od spremembe naprej. Željene spremembe lahko izvedeš tudi na že obstojeèih slikah z uporabo &quot;<a href="util.php">administracijskih orodij</a> (spreminjanje velikosti slik)&quot; pripomoèka, ki se nahaja v administracijskem meniju.</div><br />', //cpg1.3.0
);
...
if (defined('DB_ECARD_PHP')) $lang_db_ecard_php = array(
  ...
  'ecard_ascending' => 'narašèajoèe', //cpg1.3.0
  'ecard_descending' => 'padajoèe', //cpg1.3.0
  ...
  'check_all' => 'Oznaèi vse', //cpg1.3.0
  'uncheck_all' => 'Odznaèi vse', //cpg1.3.0
  'ecards_delete_selected' => 'Briši oznaèeno', //cpg1.3.0
  'ecards_delete_confirm' => 'Si preprièan, da želiš to narediti? Oznaèi ustrezno polje!', //cpg1.3.0
  'ecards_delete_sure' => 'Sem preprièan!', //cpg1.3.0
);
...
if (defined('DB_INPUT_PHP')) $lang_db_input_php = array(
  ...
  'no_pic_uploaded' => 'Nobena slika ni bila dodana!<br /><br />Èe si resnièno poslal sliko, preveri ali je to sploh dovoljeno...', //cpg1.3.0
  ...
  'notify_admin_email_body' => 'Dodane so bile slike (pošiljatelj: %s) in èakajo na odobritev. Obišèi %s', //cpg1.3.0
  'info' => 'Informacija',
  ...
  'no_flood' => 'Oprosti, ampak si že avtor zadnjega komentarja za to sliko<br /><br />Izberi urejanje,èe ga želiš spremeniti', //cpg1.3.0
...
$lang_picinfo = array(
  ...
  'iptcKeywords'=>'IPTC kljuène besede', //cpg1.3.0
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php =array(
  ...
  'send_failed' => 'Oprosti, ampak server ne omogoèa pošiljanja razglednic...',
  'from' => 'Od',
  'your_name' => 'Tvoje ime',
...
if (defined('EDITPICS_PHP')) $lang_editpics_php = array(
  ...
  'sel_on_img' =>'Izbrano podroèje mora biti na sliki!', //js-alert //cpg1.3.0
);
...
if (defined('FAQ_PHP')) $lang_faq_data = array(
  ...
  array('Zakaj je potrebna registracija?', 'Registracija je ali pa ni potrebna - o tem odloèa administrator. Registracija daje èlanom dodatne možnosti kot je dodajanje slik, kreiranje priljubljenih slik, urejanje albumov, ocenjevanje slik, dodajanje komentarjev....', 'allow_user_registration', '0'), //cpg1.3.0
  array('Kako se registriram?', 'Pojdi na &quot;Registracija&quot; in izpolni obrazec.<br />Èe je administrator vklopil obvešèanje preko e-mail naslovov, prejmeš na svoj e-mail naslov sporoèilo z navodili za aktiviranje svojega raèuna in s tem boš imel možnost, da se s svojimi podatki potem prijaviš.', 'allow_user_registration', '1'), //cpg1.3.0
  array('Kako se prijavim?', 'Pojdi na &quot;Prijava&quot;, vpiši svoje uporabniško ime in geslo, odkljukaj polje &quot;Zapomni si me&quot; in boš prijavljen.<br /><b>POMEMBNO:omogoèeno moraš imeti uporabo piškotkov in pa le-ti ne smejo biti pobrisani, èe hoèeš izkoristiti tudi opcijo &quot;Zapomni si me&quot;.</b>', 'offline', 0), //cpg1.3.0
  array('Zakaj se ne morem prijaviti?', 'Si se že registriral in odgovoril na povezavo, ki ti je bila poslana preko e-mail sporoèila?. Poslana povezava služi za aktiviranje tvojega raèuna. Za ostale težave pri prijavi pošlji e-mail administratorju.', 'offline', 0), //cpg1.3.0
  array('Kaj èe pozabim geslo?', 'Èe se le da, uporabi povezavo &quot;Pozabljeno geslo&quot;. V nasprotnem primeru pošlji e-mail administratorju in zaprosi za novo geslo.', 'offline', 0), //cpg1.3.0
  //array('Kaj èe sem spremenil svoj e-mail naslov?', 'Prijavi se in v svojih nastavitvah popravi naslov. Uporabi povezavo &quot;Profil&quot;', 'offline', 0), //cpg1.3.0
  array('Kako shranim sliko v &quot;Moji favoriti&quot;?', 'Klikni na sliko in vklopi prikaz &quot;informacija o sliki&quot; (<img src="images/info.gif" width="16" height="16" border="0" alt="Informacija o sliki" />); v okvirèku s podatki najdeš povezavo &quot;Dodaj med priljubljene&quot;.<br />Informacija o sliki je mogoèe že vklopljena, kar pa je odvisno od nastavitev same galerije.<br />POMEMBNO:omogoèeno moraš imeti uporabo piškotkov in pa le-ti ne smejo biti pobrisani.', 'offline', 0), //cpg1.3.0
  array('Kako lahko ocenim sliko?', 'Pri ogledu posamezne slike imaš možnost tudi oceniti le-to (seveda le, èe je to dovoljeno s strani lastnika albuma). Klikni na slikico, ki predstavlja posamezno oceno.', 'offline', 0), //cpg1.3.0
  array('Kako lahko dodam komentar?', 'Pri ogledu posamezne slike imaš možnost tudi dodati svoj komentar (seveda le, èe je to dovoljeno s strani lastnika albuma).', 'offline', 0), //cpg1.3.0
  array('Kako lahko dodam svojo sliko?', 'Izberi &quot;Nalaganje slik&quot;in doloèi najprej album v katerega jo želiš dodati, klikni na &quot;Prebrskaj&quot; in najdi sliko na disku, ki jo želiš dodati. Ko jo najdeš, klikni &quot;odpri/open&quot; (vpiši naslov za sliko in opis, èe želiš) in klikni konèno še &quot;Dodaj sliko&quot;', 'allow_private_albums', 0), //cpg1.3.0
  array('Kam lahko dodam sliko?', 'Imaš možnost, da jo dodaš v enega od svojih albumov v &quot;Moja galerija&quot; ali pa, v katerikoli drugi album, èe je administrator to omogoèil.', 'allow_private_albums', 0), //cpg1.3.0
  array('Kako velike in kakšne vrste slik lahko dodam?', 'Velikost in vrsta slik (jpg,gif,...) sta doloèena s strani administratorja.', 'offline', 0), //cpg1.3.0
  array('Kaj je &quot;Moja galerija&quot;?', '&quot;Moja galerija&quot; je osebna galerija, ki jo lahko imajo registrirani uporabniki. Omogoèa pa samostojno urejanje in upravljanje s slikami in albumi.', 'allow_private_albums', 0), //cpg1.3.0
  array('Kako lahko ustvarim, spremenim ali brišem albume v&quot;Moji galeriji&quot;?', 'Biti moraš prijavljen in v &quot;naèinu za administracijo&quot;<br />Klikni na &quot;Ustvari/naroèi svoj album&quot; in klikni na &quot;Novo&quot;. Spremeni &quot;Novi album&quot; v svoje željeno ime za album.<br />V svoji galeriji lahko tako preimenuješ kateri koli album.<br />Klikni na &quot;Izvedi spremembe&quot;.', 'allow_private_albums', 0), //cpg1.3.0
  array('Kako lahko doloèim, da ostali ne vidijo slik v mojem albumu?', 'Biti moraš prijavljen in v &quot;naèinu za administracijo&quot;<br />Klikni na &quot;Spremeni svoj album&quot; Sedaj lahko nastaviš možnosti za tvoj album (dovoliš dodajanje slik, ocenjevanje slik, dodajanje komentarjev in pa dostop do albuma).<br />Na koncu klikni še &quot;Posodobi album&quot;.', 'allow_private_albums', 0), //cpg1.3.0
  ...
  array('Kaj so piškotki?', 'Piškotki so majhbe tekstovne datoteke, ki jih web stran shrani na tvojem raèunalniku.<br />piškotki omogoèajo lažjo prijavo na web strani.', 'offline', 0), //cpg1.3.0
  array('Kje lahko najdem ta program za svoje web strani?', 'Coppermine je prosta multimedijska galerija, objavljena pod GNU GPL. Omogoèa veliko raznoraznih funkcij in je predvidena za razliène sisteme. Obišèi <a href="http://coppermine.sf.net/">domaèo stran od Coppermine galerije</a> za download in ostale informacije.', 'offline', 0), //cpg1.3.0
  ...
  array('Kakšna je razlika med &quot;Administracijo&quot; in &quot;Uporabniškim naèinom&quot;?', 'Administracija omogoèa uporabnikom spreminjanje oz. urejanje svojih albumov in s tem slik.', 'allow_private_albums', 0), //cpg1.3.0
  array('Kaj pomeni &quot;Nalaganje slik&quot;?', 'To je možnost, da v posamezni album dodajaš slike (vrsta in velikost ter album so doloèeni s strani administratorja).', 'allow_private_albums', 0), //cpg1.3.0
  ...
  array('Kaj pomeni &quot;Najveè ogledov&quot;?', 'Tukaj vidiš seznam slik, ki so bile najveèkrat pogledane s strani obiskovalcev.', 'offline', 0), //cpg1.3.0
  array('Kaj pomeni &quot;Najbolj ocenjeno&quot;?', 'Tukaj vidiš seznam slik, ki so dobile najveèje ocene s strani obiskovalcev, prikazana je povpreèna ocena (primer: 5 uporabnikov, vsak da oceno <img src="images/rating3.gif" width="65" height="14" border="0" alt="" />: slika bo imela povpreèno oceno <img src="images/rating3.gif" width="65" height="14" border="0" alt="" /> ;Pet uporabnikov oceni sliko z ocenami od 1 do 5 (1,2,3,4,5) - rezultat bo povpreèna ocena <img src="images/rating3.gif" width="65" height="14" border="0" alt="" /> .)<br />Ocene so od <img src="images/rating5.gif" width="65" height="14" border="0" alt="best" /> (super) do <img src="images/rating0.gif" width="65" height="14" border="0" alt="worst" /> (zaniè).', 'offline', 0), //cpg1.3.0
  array('Kaj so &quot;Moji favoriti&quot;?', 'To omogoèa, da se v piškotek shrani seznam uporabniku najlepših slik.', 'offline', 0), //cpg1.3.0
);
...
if (defined('FORGOT_PASSWD_PHP')) $lang_forgot_passwd_php = array(
  ...
  'failed_sending_email' => 'Sporoèila o pozabljenem geslu ni možno poslati!', //cpg1.3.0
  'email_sent' => 'Sporoèilo s tvojim uporabniškim imenom in geslo je bilo poslano na %s', //cpg1.3.0
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array(
  ...
  'confirm_del' => 'Opozorilo: pri brisanju skupine se vsi èlani premaknejo v skupino z imenom \'Registered\'!\n\nŽeliš nadaljevati?', //js-alert //cpg1.3.0
...
if (defined('PHPINFO_PHP')) $lang_phpinfo_php = array(
  ...
  'no_link' => 'Èe te podatke vidijo ostali je to lahko varnostno sporno. Zato jih lahko vidiš samo, èe si prijavljen kot administrator. Èeprav bi ostalim poslal pot do te strani, je ne bodo videli.', //cpg1.3.0
);
...
<br />
S sodelovanjem na teh spletnih straneh se tudi strinjate, da ne boste objavljali nobenih obscenih, vulgarnih, žaljivih, seksualnih, sovražnih, rasno nestrpnih in ostalih vsebin, ki so v nasprotju z veljavno zakonodajo. Strinjate se tudi, da ima aministrator in/ali moderator doloèenih vsebin na {SITE_NAME} pravico v katerem koli trenutku odstraniti po njegovem mnenju sporni objavljeni prispevek. Kot uporabnik se strinjate, da je z vaše strani objavljeno gradivo shranjeno v bazi. Èeprav ti podatki ne bodo posredovani nobeni tretji stranki, administrator oziroma skrbnik teh strani ne odgovarja za izgubljene podatke v primeru hekerskega poskusa kraje podatkov.<br />
<br />
...
S klikom na 'STRINJAM SE' potrjujete, da ste seznanjeni s pogoji sodelovanje na straneh {SITE_NAME} in da je poslano gradivo vaša osebna last. V nasprotnem primeru ste dolžni navesti izvor poslanega gradiva. Prav tako ste dolžni navesti kot izvor {SITE_NAME}, èe uporabite gradivo s teh strani. Dovoljena je izkljuèno uporaba v izobraževalne namene. Za vse ostale primere si morate priskrbeti dovoljenje lastnika teh strani.<br />
EOT;
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array(
  ...
  'select_dir_msg' => 'Ta ukaz ti omogoèa dodajanje slik, ki si jih dodal na server s pomoèjo FTP protokola.<br /><br />Izberi direktorij v katerega si dodal slike', //cpg1.3.0
  'no_pic_to_add' => 'Tu ni nobenih slik za dodajanje', //cpg1.3.0
  'need_one_album' => 'Za uporabo te funkcije moraš imeti vsaj en album',
  'warning' => 'Opozorilo',
  'change_perm' => 'pisanje v direktorij ni omogoèeno, spremeni pravice v 755 ali 777 pred ponovnim poskusom dodajanja slik!', //cpg1.3.0
  ...
  'dir_cant_read' => 'Branje onemogoèeno. ',
  ...
  'be_patient' => 'Potrpežljivost... dodajanje traja nekaj èasa', //cpg1.3.0
  ...
  'notes' =>  '<ul>'.
                          ...
                          '<li><b>NA</b> : pomeni, da nisi izbral albuma za slike, klikni \'<a href="javascript:history.back(1)">nazaj</a>\' in izberi album. Èe albuma še nimaš, <a href="albmgr.php">ustvari enega najprej</a></li>'.
...
if (defined('BANNING_PHP')) $lang_banning_php = array(
  ...
  'error_ban_id' => 'Napaèna IP številka!', //cpg1.3.0
...
if (defined('UPLOAD_PHP')) $lang_upload_php = array(
  ...
  'cust_instr_1' => 'Izbereš lahko poljubno število datotek za upload, vendar najveè kot je navedeno spodaj.', //cpg1.3.0
  'cust_instr_2' => 'Številka zahtevka', //cpg1.3.0
  'cust_instr_3' => 'Upload datotek (najveè): %s', //cpg1.3.0
  'cust_instr_4' => 'URI/URL upload (najveè): %s', //cpg1.3.0
  'cust_instr_5' => 'URI/URL upload:', //cpg1.3.0
  'cust_instr_6' => 'Upload datotek:', //cpg1.3.0
  'cust_instr_7' => 'Izberi število posameznih naèinov za upload in klikni \'NAPREJ\'. ', //cpg1.3.0
  'reg_instr_1' => 'Napaèni ukaz za obrazec.', //cpg1.3.0
  'reg_instr_2' => 'Sedaj lahko dodaš/pošlješ svoje datoteke na server. Velikost posamezne datoteke ne sme preseèi %s kB. ZIP datoteke dodane s pomoèjo \'Upload datotek\' in \'URI/URL dodajanje\' bodo ostale kompresirane.', //cpg1.3.0
  'reg_instr_3' => 'Èe hoèeš, da bodo ZIP datoteke razpakirane, uporabi polje \'Dekompresivni ZIP upload\'.', //cpg1.3.0
  'reg_instr_4' => 'Ko uporabljaš URI/URL upload, vpiši pot do datoteke na naslednji naèin: http://www.mojastran.com/images/slika.jpg', //cpg1.3.0
  ...
  'error_report' => 'Poroèilo o napaki', //cpg1.3.0
  'error_instr' => 'Tvoja zahteva za upload je povzroèila napako:', //cpg1.3.0
  'file_name_url' => 'Slika ime/URL', //cpg1.3.0
  'error_message' => 'Sporoèilo o napaki', //cpg1.3.0
  'no_post' => 'Slike niso bile poslane.', //cpg1.3.0
  'forb_ext' => 'Napaèna konènica datoteke.', //cpg1.3.0
  ...
  'impossible' => 'Tega ni moè premakniti.', //cpg1.3.0
  'not_image' => 'Datoteka ni slika/pokvarjena', //cpg1.3.0
  'not_GD' => 'Slika ni dovoljena za GD knjižnico(gif,jpg).', //cpg1.3.0
  'pixel_allowance' => 'Pixel toleranca prekoraèena.', //cpg1.3.0
  'incorrect_prefix' => 'Napaèen URI/URL prefix', //cpg1.3.0
  ...
  'http_402' => '402 Potrebno plaèilo', //cpg1.3.0
  ...
  'max_fsize' => 'najveèja dovoljena velikost je %s kB',
  'album' => 'Album',
  'picture' => 'Slika', //cpg1.3.0
  'pic_title' => 'Ime slike', //cpg1.3.0
  'description' => 'Opis slike', //cpg1.3.0
  'keywords' => 'Kljuène besede (loèi s presledki)',
  'err_no_alb_uploadables' => 'Oprosti, trenutno nobeden album ne omogoèa dodajanja slik', //cpg1.3.0
  'place_instr_1' => 'Dodaj vse slike sedaj. Vpišeš lahko tudi dodatne informacije za posamezno sliko.', //cpg1.3.0
  'place_instr_2' => 'Na dodajanje èaka še veè slik. Prosim klikni \'NAPREJ\'.', //cpg1.3.0
...
if (defined('USERMGR_PHP')) $lang_usermgr_php = array(
  ...
  'lv_a' => 'Zadnji obiski narašèajoèe', //cpg1.3.0
  'lv_d' => 'Zadnji obiski padajoèe', //cpg1.3.0
...
if (defined('UTIL_PHP')) $lang_util_php = array(
  ...
  'nonexist' => 'pripeto k neobstojeèi sliki # ', //cpg1.3.0
  'phpinfo' => 'Prikaži phpinfo', //cpg1.3.0
  'update_db' => 'Posodobi bazo', //cpg1.3.0
  'update_db_explanation' => 'Èe si zamenjal kakšne datoteke od galerije, dodal spremembe ali nadgradil s prejšnje verije, izvedi vsaj enkrat ukaz "posodobi bazo". To bo naredilo potrebne spremembe v bazi, kreiralo manjkajoèe tabele in nastavilo potrebne vrednosti za delovanje v konfiguracijskih tabelah.', //cpg1.3.0
);
