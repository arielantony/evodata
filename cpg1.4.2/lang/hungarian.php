...
/*************************
  ...
  ********************************************
  ...
  $Source: /cvsroot/coppermine/devel/lang/hungarian.php,v $
  $Revision: 1.9 $
  $Author: chtito $
  $Date: 2005/01/04 19:01:56 $
**********************************************/
// ------------------------------------------------------------------------- //
// $Id: hungarian.php,v 1.9 2005/01/04 19:01:56 chtito Exp $
// ------------------------------------------------------------------------- //
...
$lang_errors = array(
        ...
        'perm_denied' => 'Nincs jogosultságod ennek a műveletnek az elvégzéséhez.',
        ...
        'invalid_image' => 'A feltöltött kép sérült, vagy a GD könyvtár által nem kezelhető',
        ...
        'orphan_cat' => 'A kategória szülőkategóriája nem létezik, futtasd a kategóriamenedzsert a probléma kiküszöbölésére.',
        ...
        'pic_in_invalid_album' => 'Fájl nem létező albumban (%s)!?', //cpg1.3.0
        ...
        'offline_text' => 'A galéria jelenleg  offline - látogass vissza később', //cpg1.3.0
        'ecards_empty' => 'Jelenleg nincs megjeleníthető e-képeslap. Ellenőrizd, hogy engedélyezted -e az e-lapok naplózását a coppermine konfigurációban!', //cpg1.3.0
        'action_failed' => 'A művelet sikertelen.  Coppermine nem tudja feldolgozni a kérést.', //cpg1.3.0
...
$lang_bbcode_help = 'A következő kódok hasznosak lehetnek: <li>[b]<b>Bold</b>[/b]</li> <li>[i]<i>Italic</i>[/i]</li> <li>[url=http://yoursite.com/]Url Text[/url]</li> <li>[email]user@domain.com[/email]</li>'; //cpg1.3.0
...
$lang_thumb_view = array(
        ...
        'name' => 'NÉV',
        'title' => 'Kép cím',
        'sort_da' => 'Dátum szerinti sorrendezés, növekvő',
        'sort_dd' => 'Dátum szerinti sorrendezés, csökkenő',
        'sort_na' => 'Név szerinti sorrendezés, növekvő',
        'sort_nd' => 'Név szerinti sorrendezés, csökkenő',
        'sort_ta' => 'Sorrendezés cím szerint - növekvő',
        'sort_td' => 'Sorrendezés cím szerint - csökkenő',
...
$lang_img_nav_bar = array(
        ...
        'prev_title' => 'Előző fájl', //cpg1.3.0
        'next_title' => 'Következő fájl', //cpg1.3.0
...
if (defined('SMILIES_PHP')) $lang_smilies_inc_php = array(
        ...
        'Evil or Very Mad' => 'Gonosz vagy őrült',
...
if (defined('ALBMGR_PHP')) $lang_albmgr_php = array(
        ...
        'confirm_delete2' => '\nA tartalmazott összes kép és hozzászólás törlődik!', //js-alert
        'select_first' => 'Először válassz albumot', //js-alert
...
if (defined('CONFIG_PHP')) $lang_config_data = array(
        ...
        array('Nyelv', 'lang', 5),
        array('Téma', 'theme', 6),
        array('Legördülő nyelv-menü megjelenítése', 'language_list', 1), //cpg1.3.0
        ...
        array('Legördülő téma-menü megjelenítése', 'theme_list', 1), //cpg1.3.0
        ...
        array('Megjelenítendő tab- fülek maximális száma', 'max_tabs', 10), //cpg1.3.0
        ...
        array('Feltöltő nevének kijelzése az ikon alatt', 'display_uploader', 1), //cpg1.3.0
        ...
        array('Több egymást követő hozzászólás engedélyezése egy képhez ugyanazon felhasználónak (visszaélés védelem tiltása)', 'disable_comment_flood_protect', 1), //cpg1.3.0
        ...
        array('Diavetítés idő intervalluma milliszekundumban (1 second = 1000 milliseconds)', 'slideshow_interval', 0), //cpg1.3.0
        ...
        array('Közbenső méretű kép / videó maximális szélessége és magassága <a href="#notice2" class="clickable_option">**</a>', 'picture_width', 0), //cpg1.3.0
  	...
  	array('Közbenső méretezésű képek prefixe <a href="#notice1" class="clickable_option">*</a>', 'normal_pfx', 0), //cpg1.3.0
  	...
  	array('Fájlok alapértelmezett módja', 'default_file_mode', 0), //cpg1.3.0
        ...
        array('Regisztráció email megerősítéshez kötött', 'reg_requires_valid_email', 1),
        ...
        array('Felhasználóknak lehetnek privát albumai (Megjegyzés: ha \'igen\' -ről \'nem\' -re váltasz, minden jelenlegi privát album publikussá válik)', 'allow_private_albums', 1), //cpg1.3.0
  		array('Admin értesítése jóváhagyásra váró feltöltésről', 'upl_notify_admin_email', 1), //cpg1.3.0
        ...
        'Cooky beállítások',
        array('A szkript által használt cooky név (bbs integráció esetén győződj meg róla, hogy eltér a bbs cooky névtől)', 'cookie_name', 0),
        ...
        '<br /><div align="left"><a name="notice1"></a>(*) * -gal jelölt mezőket nem szabad megváltoztatni, ha már nem üres a képtár.<br />
		<a name="notice2"></a>(**) Ha ezt a beállítást megváltoztatod, csak azok a fájlok lesznek érintve, melyeket ettől kezdve adsz hozzá, ezért ajánlatos ezt a beállítást nem megváltoztatni, ha már van fájl a képtárban. Azonban tetszőleges albumra érvényesíteni tudod a kívánt változtatásokat az adminisztrátori menü &quot;<a href="util.php">Admin eszközök</a>&quot; menüpontjában.</div><br />', //cpg1.3.0
);
...
if (defined('DB_ECARD_PHP')) $lang_db_ecard_php = array(
  ...
  'ecard_ascending' => 'növekvő', //cpg1.3.0
  'ecard_descending' => 'csökkenő', //cpg1.3.0
  ...
  'ecard_number' => 'Rekordok kijelzése: %s től %s összesen %s', //cpg1.3.0
...
if (defined('DB_INPUT_PHP')) $lang_db_input_php = array(
        ...
        'no_pic_uploaded' => 'Nem történt feltöltés!<br /><br />Ha tényleg kijelöltél feltöltésre fájlt, ellenőrizd, hogy a szerveren megengedett-e a feltöltés...', //cpg1.3.0
		...
		'notify_admin_email_subject' => '%s - Értesítés feltöltésről', //cpg1.3.0
        ...
        'err_invalid_fext' => 'Csak a következő kiterjesztésű fájlok megengedettek: <br /><br />%s.',
        'no_flood' => 'Már hozzászóltál a fájlhoz.<br /><br />Szerkeszd az előző hozzászólásod, ha szükséges', //cpg1.3.0
...
if (defined('DELETE_PHP')) $lang_delete_php = array(
        ...
        'err_invalid_data' => 'Érvénytelen adat a következőben \'%s\'',
...
$lang_display_comments = array(
        ...
        'add_your_comment' => 'Hozzászólás hozzáfűzése',
        'name'=>'Név',
        'comment'=>'Megjegyzés',
        'your_name' => 'Anon',
);
...
if (defined('ECARDS_PHP') || defined('DISPLAYECARD_PHP')) $lang_ecard_php =array(
        ...
        'view_ecard' => 'Ha az e-képeslap nem jelenik meg helyesen, klikkelj a következő linkre',
...
if (defined('EDITPICS_PHP')) $lang_editpics_php = array(
        ...
        'postpone_app' => 'Jóváhagyás később',
        ...
        'see_next' => 'Következő fájl', //cpg1.3.0
        'see_prev' => 'Előző fájl', //cpg1.3.0
        'n_pic' => '%s db fájl', //cpg1.3.0
        'n_of_pic_to_disp' => 'Fájl / oldal', //cpg1.3.0
        'apply' => 'Módosítások végrehajtása', //cpg1.3.0
		'crop_title' => 'Coppermine képszerkesztő', //cpg1.3.0
		'preview' => 'Előnézet', //cpg1.3.0
...
if (defined('FAQ_PHP')) $lang_faq_data = array(
  ...
  //array('Mi történik, ha megváltozott az e-mail címem?', 'Egyszerűen lépj be és a &quot;Profilom&quot; menüben változtasd meg az e-mail címedet!', 'offline', 0), //cpg1.3.0
  ...
  array('Hogyan osztályozhatom a fájlokat?', 'Klikkelj az ikonizált képre, görgess az aljára, és válaszd a &quot;Fájl osztályozása&quot; részben klikkelj a megfelelő osztályzatra!', 'offline', 0), //cpg1.3.0
  ...
  array('Hogyan tölthetek fel fájlokat?', 'Menj a &quot;Feltöltés&quot; menübe és válaszd ki az albumot, amelyikbe fájlt akarsz feltölteni! Klikkelj a &quot;Browse...&quot; gombra és válaszd ki a feltöltendő fájlt! Megadhatsz címet és képaláírást is igény szerint. Végül klikkelj a &quot;TOVÁBB&quot; gombra.', 'allow_private_albums', 0), //cpg1.3.0
  array('Hova tölthetek fel fájlokat?', 'Az &quot;Képtáram&quot; valamelyik albumába tölthetsz fel fájlokat. Az adminisztrátor engedélyezheti, hogy feltölthess fájlokat a főképtár egy vagy több albumába is.', 'allow_private_albums', 0), //cpg1.3.0
  array('Milyen típusú és méretű fájlt tölthetek fel?', 'A méretet és típust (jpg,gif,..etc.) az adminisztrátor döntheti el.', 'offline', 0), //cpg1.3.0
...
&quot; menübe és klikkelj a &quot;Új&quot; gombra. Írd át az &quot;Új album&quot;-ot a kívánt névre.<br />A képtárad bármelyik meglévő albumát is átnevezheted.<br />Klikkelj a &quot;Módosítások végrehajtása&quot;-ra.', 'allow_private_albums', 0), //cpg1.3.0
  array('Hogyan szabályozhatom, hogy a felhasználók láthassák-e az albumomat?','&quot;Admin mód&quot;-ban kell, hogy legyél.<br />Menj a &quot;Személyes albumom tulajdonságai&quot;-ba. Az &quot;Album módosítása&quot; legördülő menüből válaszd ki a kívánt albumot.<br />Itt megváltoztathatod az album nevét, leírását, ikonizált képét, és korlátozhatod az albumban lévő fájlok megtekintését, osztályozását, és hozzászólások postázását.<br />Klikkelj ezután az &quot;Album módosítása&quot; gombra!.', 'allow_private_albums', 0), //cpg1.3.0
  ...
  array('Mik a Cooky-k?', 'A cooky-k szöveges adatállományok, melyeket a webhely küld a számítógépedre.<br />A cooky-k általában azt teszik lehetővé, hogy a felhasználó ismételt bejelentkezés nélkül is visszataláljon a webhelyre, és egyéb hasonló kényelmi lehetőségeket biztosít.', 'offline', 0), //cpg1.3.0
  array('Hol kaphatom meg ezt a programot a webhelyemre?', 'Coppermine egy ingyenes multimédiás képtár, GNU GPL licensszel. Tele van szolgáltatásokkal és különböző platformokon működik. Látogass el a <a href="http://coppermine.sf.net/">Coppermine honlap</a>-ra további információért és a program letöltéséért.', 'offline', 0), //cpg1.3.0
  ...
  array('Mi a &quot;Feltöltése&quot;?', 'Ez a szolgáltatás lehetővé teszi a felhasználóknak fájlok feltöltését egy az általad vagy az adminisztrátor által megadott képtárba (méretet és típust az adminisztrátor engedélyez).', 'allow_private_albums', 0), //cpg1.3.0
  ...
  array('Mi a &quot;Legtöbb szavazat&quot;?', 'Ez a szolgáltatás mutatja legtöbb szavazatot kapott fájlokat, az átlagosztályzattal (például ha 5 felhasználó mindegyike <img src="images/rating3.gif" width="65" height="14" border="0" alt="" />-t adott, akkor a kép átlagosztályzata <img src="images/rating3.gif" width="65" height="14" border="0" alt="" />. Ha ö felhasználó 1-től 5-ig osztályozott (1,2,3,4,5), akkor az átlagosztályzat <img src="images/rating3.gif" width="65" height="14" border="0" alt="" /> lesz.)<br />Az osztályzat <img src="images/rating5.gif" width="65" height="14" border="0" alt="best" />-tő (legjobb) megy <img src="images/rating0.gif" width="65" height="14" border="0" alt="worst" />-ig (legrosszabb).', 'offline', 0), //cpg1.3.0
  array('Mi a &quot;Kedvencek&quot;?', 'Ez a szolgáltatás a felhasználó számára lehetővé teszi, hogy kedvenc képeire cooky segítségével emlékezzen a számítógép.', 'offline', 0), //cpg1.3.0
);
...
if (defined('FORGOT_PASSWD_PHP')) $lang_forgot_passwd_php = array(
  'forgot_passwd' => 'Jelszó emlékeztető', //cpg1.3.0
  ...
  'submit' => 'mehet', //cpg1.3.0
  'failed_sending_email' => 'A jelszó-emlékeztető e-mail kiküldése nem sikerült!', //cpg1.3.0
  ...
  'passwd_reminder_subject' => '%s - Jelszó-emlékeztető', //cpg1.3.0
...
if (defined('GROUPMGR_PHP')) $lang_groupmgr_php = array(
        ...
        'confirm_del' => 'Figyelmeztetés: ha törölsz egy csoportot, a hozzá tartozó felhasználók áthelyeződnek a \'Regisztráltak\' csoportba !\n\nFolytatod ?', //js-alert //cpg1.3.0
        ...
        'note1' => '<b>(1)</b> A nyilvános albumba történő feltöltés adminisztrátori jóváhagyást igényel',
        'note2' => '<b>(2)</b> A felhasználó albumába történő feltöltés adminisztrátori jóváhagyást igényel',
        'notes' => 'Megjegyzések',
);
...
$lang_album_admin_menu = array(
        'confirm_delete' => 'Biztos törölni akarod az albumot? \\nMinden fájl és hozzászólás is törlődik!', //js-alert //cpg1.3.0
        'delete' => 'TÖRLÉS',
...
if (defined('PHPINFO_PHP')) $lang_phpinfo_php = array(
  ...
  'no_link' => 'Saját phpinfód megmutatása másoknak biztonsági rizikót jelenthet, ezért ez az oldal csak admin módban látható. Erről az oldlról nem postázhatsz linket másoknak, ezekhez a hozzáférés le lesz tiltva.', //cpg1.3.0
);
...
if (defined('MODIFYALB_PHP')) $lang_modifyalb_php = array(
		...
		'notice1' => '(*) a %sgroups%s beállításoktól függően', //cpg1.3.0 (do not translate %s!)
);
...
Bár a {SITE_NAME} adminisztrátora mindent elkövet, hogy amilyen gyorsan csak lehet, szerkesszen vagy töröljön minden kifogásolható dokumentumot, lehetetlen minden küldemény ellenőrzése. Kérjük ezért annak megértését, hogy minden erre a weblapra címzett küldemény annak szerzője nézetét és véleményét fejezi ki, és nem az adminisztrátorét, illetve webmesterét (kivéve az általuk postázott küldeményeket). Ennél fogva nem tudunk értük felelősséget vállalni.<br />
<br />
Elfogadod, hogy nem postázol semmilyen sértő, obszcén, vulgáris, rágalmazó, gyűlölködő, fenyegető, szexuális tartalmú, vagy bármilyen más olyan tartalmú anyagot, amely érvényes törvényt sért. Elfogadod, hogy a {SITE_NAME} webmesterének, adminisztrátorának, vagy moderátorának bármikor jogában áll bármilyen tartalmat szükség esetén törölni, vagy szerkeszteni. Mint felhasználó egyetértesz a közölt információk adatbázisban történő tárolásához. Bár a webmester, illetve adminisztrátor nem adja ki harmadik feleknek ezeket az információkat a hozzájárulásod nélkül, nem tehető felelőssé semmilyen olyan hacker kísérletért, melyek az adatok kompromittálásához vezet.<br />
<br />
Ez a weblap cooky formájában információt tárol a számítógépeden. Ezek a cooky-k csak azt a célt szolgálják, hogy fokozzák a nézhetőségi élményt. Az email cím csak a regisztrációs adataidnak és jelszavadnak nyugtázására szolgál.<br />
<br />
...
$lang_register_php = array(
        ...
        'failed_sending_email' => 'A regisztrációs megerősítő emailt nem sikerült elküldeni !',
...
if (defined('REVIEWCOM_PHP')) $lang_reviewcom_php = array(
        ...
        'n_comm_disp' => 'Megjelenítendő hozzászólások száma',
        'see_prev' => 'Előző',
        'see_next' => 'Következő',
...
if (defined('SEARCHNEW_PHP')) $lang_search_new_php = array(
        ...
        'select_dir_msg' => 'Ez a funkció lehetővé teszi egy köteg - FTP-vel a szerverre másolt - fájl hozzáadását a képtárhoz.<br /><br />Válaszd ki a könyvtárat, ahonnan hozzá akarsz adni a képtárhoz fájlokat', //cpg1.3.0
        'no_pic_to_add' => 'Nincs hozzáadható fájl', //cpg1.3.0
        'need_one_album' => 'Ehhez a funkcióhoz legalább egy albumnak léteznie kell',
        'warning' => 'Figyelmeztetés',
        'change_perm' => 'a szkript nem tud írni ebbe a könyvtárba, 755-ről 777-re kell cserélned a jogosultságát mielőtt hozzáadsz fájlokat!', //cpg1.3.0
        ...
        'be_patient' => 'Légy türelemmel, a szkriptnek idő kell a fájlok hozzáadásához', //cpg1.3.0
        ...
        'notes' =>  '<ul>'.
                                ...
                                '<li><b>PB</b> : azt jelenti, hogy a fájl nem volt hozzáadható, ellenőrizd a konfigurációt és a fájlokat tartalmazó könyvtárak jogosultságait '. //cpg1.3.0
		                        '<li><b>NA</b> : azt jelenti, hogy nem választottad ki az albumot, melybe a fájlokat fel akarod tölteni, üss \'<a href="javascript:history.back(1)">back</a>\'-t és válassz ki egy albumot. Ha nincs egy albumod se, akkor <a href="albmgr.php">először generálj egyet</a></li>'.
                                '<li>Ha az OK, DP, PB \'jelek\' nem láthatók, klikkelj a hibás fájlra a PHP hibaüzenetének megjelenítéséhez'. //cpg1.3.0
                                '<li>Ha a browser leidőzített, nyomja meg a frissítés gombot'.
                                '</ul>',
...
if (defined('UPLOAD_PHP')) $lang_upload_php = array(
		...
		'custom_title' => 'Beállított lekérési űrlap', //cpg1.3.0
		...
		'reg_instr_2' => 'Most feltöltheted a fájljaidat az alábbi feltöltési sorok használatával. A kliensről a szerverre feltöltendő fájlok mérete egyenként nem lépheti túl a %s KB határt. A \'Fájl feltöltés\' és \'URI/URL Feltöltés\' részben feltöltött ZIP fájlok tömörítettek maradnak.', //cpg1.3.0
		'reg_instr_3' => 'Ha azt akarod, hogy a ZIP fájlod kicsomagolásra kerüljön, használd a \'Kitömörítő ZIP feltöltés\' részben található sort.', //cpg1.3.0
		'reg_instr_4' => 'Az URI/URL feltöltési részben add meg a fájl elérési útvonalat a következő módon: http://www.mysite.com/images/example.jpg', //cpg1.3.0
		'reg_instr_5' => 'Ha kitöltötted az űrlapot, nyomj \'Folytatás\'-t.', //cpg1.3.0
		'reg_instr_6' => 'Kitömörítő ZIP feltöltés:', //cpg1.3.0
		'reg_instr_7' => 'Fájl feltöltés:', //cpg1.3.0
		'reg_instr_8' => 'URI/URL feltöltés:', //cpg1.3.0
		'error_report' => 'Hibajelentés', //cpg1.3.0
		'error_instr' => 'A következő feltöltések hibát eredményeztek:', //cpg1.3.0
		...
		'http_500' => '500 belső szerver hiba', //cpg1.3.0
		'http_503' => '503 szerver nem elérhető', //cpg1.3.0
		...
		'add' => 'Üss \'Folytatás\'-t a fájlok albumhoz történő hozzáadásához.', //cpg1.3.0
		'failure' => 'Feltöltés hiba', //cpg1.3.0
		'f_info' => 'Fájl információ', //cpg1.3.0
		'no_place' => 'Az előző fájlt nem sikerült elhelyezni.', //cpg1.3.0
		'yes_place' => 'Az előző fájlt sikerült elhelyezni.', //cpg1.3.0
...
if (defined('USERMGR_PHP')) $lang_usermgr_php = array(
		...
		'lv_a' => 'Utolsó látogatás növekvő', //cpg1.3.0
		'lv_d' => 'Utolsó látogatás csökkenő', //cpg1.3.0
        ...
        'confirm_del' => 'Biztös törölni kívánod a felhasználót? \\nMinden fájlja és albuma is törlődni fog.', //js-alert //cpg1.3.0
        'mail' => 'MAIL',
        'err_unknown_user' => 'A kijelölt felhasználó nem létezik !',
        'modify_user' => 'Felhasználó módosítása',
        'notes' => 'Megjegyzések',
        'note_list' => '<li>Ha nem kívánod megváltoztatni az aktuális jelszót, hagyd üresen a "jelszó" mezőt',
        'password' => 'Jelszó',
        ...
        'user_interests' => 'Felhasználó érdeklődési köre',
...
if (defined('UTIL_PHP')) $lang_util_php = array(
        ...
        'what_update_titles' => 'Címek aktualizálása fájlnevekből',
        ...
        'main_success' => 'A % fájlok felhasználása elsődleges fájlként sikeres volt', //cpg1.3.0
        ...
        'instruction_action' => 'Művelet kiválasztása',
        ...
        'update_option' => '(Próbáld csökkenteni ezt az értéket, ha leidőzítési problémát észlelsz)',
        'filename_title' => 'Fájlnév &#8594; Fájl cím', //cpg1.3.0
        'filename_how' => 'Hogy legyen módosítva a fájlnév',
        'filename_remove' => 'A jpg végződés törlése és _ (alulvonás) helyettesítése szóközzel',
        ...
        'delete' => 'Kép címek vagy eredeti méretű képek törlése',
        'delete_title' => 'Fájl címek törlése', //cpg1.3.0
        'delete_original' => 'Eredeti méretű fájlok törlése', //cpg1.3.0
        'delete_replace' => 'Eredeti képek felülírása átméretezettel',
        'select_album' => 'Album kiválasztása',
		'delete_orphans' => 'Árva hozzászólások törlése (minden albumon működik)', //cpg1.3.0
		...
		'nonexist' => 'nem létező fájlhoz csatolva # ', //cpg1.3.0
